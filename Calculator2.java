...
public class Calculator2 {
	...
	private double ingresoAnual,
					...
					pagoExcedente,
					totalPagar;
	public Calculator2(double sueldoMensual,double aguinaldo,double primaVac,double gastosMedicos,double gastosFunerarios,double seguroMedico,double creditoHipotecario,double donativos,double cuentaRetiro,double transporteEscolar,double colegiaturaTotal,String nivelEscolar){
